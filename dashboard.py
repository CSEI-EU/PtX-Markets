...
page = st.sidebar.selectbox("Go to", ["Global Results", "Hydrogen Scenario", "Electrification Scenario", "Ammonia Scenario", "Methanol Scenario"])

if page == "Global Results":
...
elif page == "Hydrogen Scenario":
    import h2 as hydrogen
    hydrogen.show(df)
